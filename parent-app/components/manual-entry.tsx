...
export default function ManualEntry(){
  ...
  // اختيار الطالب يتم فقط بالنقر على نتيجة البحث؛ لا يوجد اختيار تلقائي من الرابط.
...
useEffect(()=>{
  ...
  return <div className="manual-entry-shell manual-v28">
    ...
    <section className="admin-command-center-v89">
      <a href="#student-workspace" className="admin-command-primary-v89"><span>01</span><div><strong>طالب وتقرير جديد</strong><small>ابحث عن الطالب وابدأ إدخال تقريره الأسبوعي</small></div></a>
      <a href="/admin/students"><span>02</span><div><strong>إدارة الطلاب</strong><small>{students.length} طالب · بيانات وحسابات أولياء الأمور</small></div></a>
      <a href="/admin/reports"><span>03</span><div><strong>سجل التقارير</strong><small>راجع التقارير المنشورة والسابقة</small></div></a>
      <a href="/admin/finance"><span>04</span><div><strong>المالية</strong><small>المدفوعات والمستحقات والتقارير المالية</small></div></a>
    </section>

    <div className="admin-section-label-v89"><div><span>مساحة العمل</span><strong>إعداد تقرير طالب</strong></div><small>الخطوات الأساسية فقط ظاهرة أمامك</small></div>

    <section id="student-workspace" className="student-search-box-v28 admin-student-search-v89">
    ...
    {selectedStudent?<div className="student-admin-layout-v30">
