...
export async function GET(){
  ...
  if(!dbConfigured){
    return NextResponse.json({
      mode:"demo",
      students:[
        {id:"std_001",code:"ST-0001",name:"محمود أحمد",phone:"01012345678",course:"EST",parentName:"أحمد محمد",parentPhone:"01098765432",reportVisible:true},
        {id:"std_002",code:"ST-0002",name:"سارة أحمد",phone:"01122334455",course:"Beginners 1",parentName:"أحمد محمد",parentPhone:"01098765432",reportVisible:true},
        {id:"std_003",code:"ST-0003",name:"يوسف علي",phone:"01233445566",course:"SAT",parentName:"علي محمود",parentPhone:"01299887766",reportVisible:false}
      ]
    });
  }
  ...
  try{
    const students=await dbSelect(
      "students",
      "select=id,code,name,phone,report_visible,course_id,courses(id,name,slug,exam_type),student_parents(relation_order,parent_accounts(id,name,phone))&order=name.asc"
    );
